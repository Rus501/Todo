...
function initTasks() {
  ...
  tasks.forEach((task) => {
    task.onclick = (e) => {
      ...
      const index = _modules_createTodo_js__WEBPACK_IMPORTED_MODULE_1__.default.findIndex(
