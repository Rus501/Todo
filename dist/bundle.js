...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initTasks": function() { return /* binding */ initTasks; }
/* harmony export */ });
...
/* harmony import */ var _images_task_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images/task.png */ "./src/images/task.png");
...
img.src = _images_task_png__WEBPACK_IMPORTED_MODULE_2__
...
function initTasks() {
	...
	tasks.forEach(task => {
		task.onclick = e => {
			...
			const index = _modules_createTodo_js__WEBPACK_IMPORTED_MODULE_1__.default.findIndex(elem => elem.index === parseInt(task.dataset.index))
			_modules_createTodo_js__WEBPACK_IMPORTED_MODULE_1__.default[index].checked = task.dataset.checked

			localStorage.setItem('myList', JSON.stringify(_modules_createTodo_js__WEBPACK_IMPORTED_MODULE_1__.default))
		}
	})		
}
initTasks()
...
function deleteTask(e) {
	...
	const index = _modules_createTodo_js__WEBPACK_IMPORTED_MODULE_1__.default.findIndex(elem => elem.index === taskIndex)
	_modules_createTodo_js__WEBPACK_IMPORTED_MODULE_1__.default.splice(index, 1) // delete from data-array
...
function closeModalOnClickOutside(e) {
	if (e.target.className.includes('modal-visible') ||
		 e.target.className.includes('close-modal')) {
			closeModal()
	}
}

modal.onclick = closeModalOnClickOutside
...
function addTaskToDOM(todo) {
	...
	;(0,_index_js__WEBPACK_IMPORTED_MODULE_0__.initTasks)() // update event listeners
	modal.classList.remove('modal-visible')
}

/* harmony default export */ __webpack_exports__["default"] = (addTaskToDOM);
...
inputDate.value = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(), 'yyyy-MM-dd')
...
const formatDate = date => {
	return (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(date), 'eee do MMM')
}
...
form.onsubmit = e => {
	...
	const task = todoFactory(taskValues.title,
									 ...
									 index)
	todos.push(task)
	;(0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.default)(task)
	saveToLocalStorage()
	index++
...
function restoreFromLocalStorage() {
	...
	todos.forEach(item => {
		...
		;(0,_DOM_js__WEBPACK_IMPORTED_MODULE_0__.default)(item)
	})
}
...
module.exports = "data:image/png;base64,";
